...
//        sources.add( new Source("Ukininko patarejas", "https://ukininkopatarejas.lt/", "http", "www", "" ,"ukininkopatarejas.lt", "", "") );
...
//        sources.add( new Source("Sputnik", "https://sputniknews.lt/", "https", "www", "" ,"sputniknews.lt", "", "") );
//        sources.add( new Source("Krepsinis.net", "https://www.krepsinis.net/", "https", "www", "" ,"krepsinis.net", "", "") );
        sources.add( new Source("Sportas", "https://www.sportas.lt/", "https", "www", "" ,"sportas.lt", "", "") );
